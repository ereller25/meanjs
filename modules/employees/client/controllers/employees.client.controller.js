(function () {
  ...
  EmployeesController.$inject = ['$scope', '$state', 'Authentication', 'employeeResolve', '$resolve', 'DepartmentsService'];

  function EmployeesController ($scope, $state, Authentication, employee, $resolve, DepartmentsService) {
    var vm = this;
